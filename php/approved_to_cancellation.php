<?php
    ...
    $sql = "UPDATE incoming_referrals SET status='Cancelled', cancellation_details='". $_POST['cancel_details']."', cancellation_time='". $currentDateTime ."' WHERE hpercode='". $_POST['global_single_hpercode']."' AND refer_to = '" . $_SESSION["hospital_name"] . "'";
