<?php 
    ...
    $sql = "SELECT COUNT(*) FROM incoming_referrals WHERE status='Approved' AND dateTimeProcessed LIKE :proc_date AND refer_to = '" . $_SESSION["hospital_name"] . "'";
                ...
                <table id="tablet" class=" border-2 border-slate-700 w-full border-collapse text-center">
                    ...
                    <tbody class="w-full">
                        ...
                        <?php 
                            ...
                            $sql = "SELECT pat_class, type, referred_by FROM incoming_referrals WHERE status='Approved' AND dateTimeProcessed LIKE :proc_date AND refer_to = '" . $_SESSION["hospital_name"] . "'";
