<?php
    ...
    $sql = "UPDATE incoming_referrals SET status='Checked', checkup_details='". $_POST['checkup_textarea']."', checkup_time='". $currentDateTime ."' WHERE hpercode='". $_POST['global_single_hpercode']."' AND refer_to = '" . $_SESSION["hospital_name"] . "'";
